...
soak, and the byte-exact planted-bug demo are in `Design Document.pdf` (Appendix B) and `BUILD.md`.
...
[`Design Document.pdf` §16](Design%20Document.pdf)):
...
| Doc | What |
|---|---|
| [`Design Document.pdf`](Design%20Document.pdf) | Full HLD + LLD (19 sections, 11 ADRs, hostile-judge Q&A) |
