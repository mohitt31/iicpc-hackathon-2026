...
# serves ws://localhost:8080/leaderboard/deltas

# 3) Terminal B: serve the leaderboard
cd frontend && python3 -m http.server 8088    # serves http://localhost:8088
```
...
**On screen:** the `landing.html` showcase, slow scroll into the glowing core, then
...
### [1:30 - 3:00] The centerpiece: Coordinated Omission, proven live
...
### [5:00 - 5:40] Proof it's deploy-ready and verified
...
| CO proof (centerpiece) | 1:30 | 3:00 |
